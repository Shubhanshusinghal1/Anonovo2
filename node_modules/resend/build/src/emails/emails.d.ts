...
import { CreateEmailOptions, CreateEmailRequestOptions, CreateEmailResponse, GetEmailResponse } from './interfaces';
export declare class Emails {
    ...
    get(id: string): Promise<import("..").ErrorResponse | GetEmailResponse>;
}
