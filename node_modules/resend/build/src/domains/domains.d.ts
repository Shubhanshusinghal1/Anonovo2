...
import { CreateDomainOptions, CreateDomainRequestOptions, CreateDomainResponse, GetDomainResponse, ListDomainsResponse } from './interfaces';
export declare class Domains {
    ...
    list(): Promise<import("..").ErrorResponse | ListDomainsResponse>;
